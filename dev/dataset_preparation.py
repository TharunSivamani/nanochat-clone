...
output_dir = os.path.join(os.environ["PWD"], ".cache/nanochat/base_data")
...
# Pushing the shards to Huggingface to utilize it during training
def upload():
    import os
    ...
    api.upload_large_folder(
        repo_id="TharunSivamani/fineweb-edu-100b-shuffle",
