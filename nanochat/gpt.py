...
- Grouped-Query Attention (GQA) support for more efficient inference
"""
...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config, layer_idx):
        ...
        self.c_k = nn.Linear(self.n_embd, self.n_kv_head * self.head_dim, bias=False)    # (768, 6*128)
        self.c_v = nn.Linear(self.n_embd, self.n_kv_head * self.head_dim, bias=False)    # (768, 6*128)
