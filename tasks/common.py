...
class Task:
    ...
    def __init__(self, start=0, stop=None, step=1):
        ...
        assert start>=0, f"Start must be a non-negative, got {start}"
    ...
    def __len__(self):
        ...
        assert num >= 0, f"Negative number of examples???: {num}" # preventing footguns
        return num
...
def render_mc(question, letters, choices):
    ...
    query += "\nRespond only with the letter of the current answer."
    return query
