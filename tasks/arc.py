...
class ARC(Task):
    ...
    def __init__(self, subset, split, **kwargs):
        ...
        assert subset in ["ARC-Easy", "ARC-Challenge"], f"ARC subset must be ARC-Easy|ARC-Challenge"
        assert split in ["train", "validation", "test"], f"ARC split must be train|validation|test"
    ...
    def get_example(self, index):
        ...
        assert answer_string in letters, f"ARC answer {answer_string} is expected to be one of {letters}" # sanity check
